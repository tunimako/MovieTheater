            ...
            using (var serviceScope = builder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Company.Any())
                {
                    ...
                    context.Movies.AddRange(new List<Movie>()
                    {
                        ...
                        new Movie("Pulp Fiction", "The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption.", 8.9, new TimeSpan(2, 34, 00), AgeRating.N16)
                        {
                            MovieGenres = new List<MovieGenre>()
                            {
                                new MovieGenre(Genre.Drama),
                    ...
                    {
                        new ShowTime(new DateTime(2023,01,22,18,20,00)) {Cinema = vilniusForum, CinemaHall = vilniusForum.CinemaHalls.Where(x => x.Id == 1).FirstOrDefault()},
